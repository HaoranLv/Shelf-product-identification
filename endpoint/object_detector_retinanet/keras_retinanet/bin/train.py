...
#     args_classes = os.path.join(data_dir, 'class_mappings_train.csv')
    ...
    args_snapshot_path = os.path.join(root_dir(abs_root=abs_root, datafolder = 'customer'), 'snapshot')
    args_tensorboard_dir = os.path.join(root_dir(abs_root=abs_root, datafolder = 'customer'), 'logs')
