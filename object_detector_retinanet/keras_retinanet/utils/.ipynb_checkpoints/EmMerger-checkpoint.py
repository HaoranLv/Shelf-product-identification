...
#    project = result_df['project'].iloc[0]
    ...
    if pixel_data is None:
        pixel_data = read_image_bgr(os.path.join(root_dir(datafolder='customer'),  image_name))
